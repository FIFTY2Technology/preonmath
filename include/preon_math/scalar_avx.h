...
#pragma once
#ifndef PREONMATH_SCALAR_AVX_H
#define PREONMATH_SCALAR_AVX_H
...
namespace Preon
{
    namespace Math
    {
        ...
        namespace Simd
        {
            ...
            template<typename scalar>
            PREONMATH_FORCEINLINE simd_if_float<scalar> make(float a) { return _mm256_set1_ps(a); }
            template<typename scalar>
            PREONMATH_FORCEINLINE simd_if_double<scalar> make(double a) { return _mm256_set1_pd(a); }
            ...
            template <typename scalar>
            PREONMATH_FORCEINLINE simd_if_float<scalar> zero() { return _mm256_setzero_ps(); }

            template <typename scalar>
            PREONMATH_FORCEINLINE simd_if_double<scalar> zero() { return _mm256_setzero_pd(); }
            ...
            PREONMATH_FORCEINLINE void storeScalars(float_simd input, const Getter& func)
            {
                float values[8];
                store(input, values);
                for (int i = 0; i < 8; i++) func(i) = values[i];
            }
            template<class Getter>
            PREONMATH_FORCEINLINE void storeScalars(double_simd input, const Getter& func)
            {
                double values[4];
                store(input, values);
                for (int i = 0; i < 4; i++) func(i) = values[i];
            }
            ...
            {
                return static_cast<bool>(_mm256_test_all_zeros(_mm256_castps_si256(x), _mm256_castps_si256(x)));
            }
...
PREONMATH_FORCEINLINE float_simd operator+(float_simd a, float_simd b) { return _mm256_add_ps(a, b); }
PREONMATH_FORCEINLINE float_simd operator-(float_simd a, float_simd b) { return _mm256_sub_ps(a, b); }
PREONMATH_FORCEINLINE float_simd operator*(float_simd a, float_simd b) { return _mm256_mul_ps(a, b); }
PREONMATH_FORCEINLINE float_simd operator/(float_simd a, float_simd b) { return _mm256_div_ps(a, b); }

PREONMATH_FORCEINLINE float_simd& operator+=(float_simd& a, float_simd b) { return a = a + b; }
PREONMATH_FORCEINLINE float_simd& operator-=(float_simd& a, float_simd b) { return a = a - b; }
PREONMATH_FORCEINLINE float_simd& operator*=(float_simd& a, float_simd b) { return a = a * b; }
PREONMATH_FORCEINLINE float_simd& operator/=(float_simd& a, float_simd b) { return a = a / b; }

PREONMATH_FORCEINLINE float_simd operator>(float_simd a, float_simd b) { return _mm256_cmpgt_ps(a, b); }
PREONMATH_FORCEINLINE float_simd operator>=(float_simd a, float_simd b) { return _mm256_cmpge_ps(a, b); }
PREONMATH_FORCEINLINE float_simd operator<(float_simd a, float_simd b) { return _mm256_cmplt_ps(a, b); }
PREONMATH_FORCEINLINE float_simd operator<=(float_simd a, float_simd b) { return _mm256_cmple_ps(a, b); }
PREONMATH_FORCEINLINE float_simd operator==(float_simd a, float_simd b) { return _mm256_cmpeq_ps(a, b); }

PREONMATH_FORCEINLINE float_simd operator-(float_simd a) { return Simd::xor_mask(a, Simd::make<float>(-0.f)); }

PREONMATH_FORCEINLINE double_simd operator+(double_simd a, double_simd b) { return _mm256_add_pd(a, b); }
PREONMATH_FORCEINLINE double_simd operator-(double_simd a, double_simd b) { return _mm256_sub_pd(a, b); }
PREONMATH_FORCEINLINE double_simd operator*(double_simd a, double_simd b) { return _mm256_mul_pd(a, b); }
PREONMATH_FORCEINLINE double_simd operator/(double_simd a, double_simd b) { return _mm256_div_pd(a, b); }

PREONMATH_FORCEINLINE double_simd& operator+=(double_simd& a, double_simd b) { return a = a + b; }
PREONMATH_FORCEINLINE double_simd& operator-=(double_simd& a, double_simd b) { return a = a - b; }
PREONMATH_FORCEINLINE double_simd& operator*=(double_simd& a, double_simd b) { return a = a * b; }
PREONMATH_FORCEINLINE double_simd& operator/=(double_simd& a, double_simd b) { return a = a / b; }

PREONMATH_FORCEINLINE double_simd operator>(double_simd a, double_simd b) { return _mm256_cmpgt_pd(a, b); }
PREONMATH_FORCEINLINE double_simd operator>=(double_simd a, double_simd b) { return _mm256_cmpge_pd(a, b); }
PREONMATH_FORCEINLINE double_simd operator<(double_simd a, double_simd b) { return _mm256_cmplt_pd(a, b); }
PREONMATH_FORCEINLINE double_simd operator<=(double_simd a, double_simd b) { return _mm256_cmple_pd(a, b); }
PREONMATH_FORCEINLINE double_simd operator==(double_simd a, double_simd b) { return _mm256_cmpeq_pd(a, b); }

PREONMATH_FORCEINLINE double_simd operator-(double_simd a) { return Simd::xor_mask(a, Simd::make<double>(-0.0)); }
#endif

namespace std
{
    PREONMATH_FORCEINLINE float_simd max(float_simd a, float_simd b) { return _mm256_max_ps(a, b); }
    PREONMATH_FORCEINLINE float_simd min(float_simd a, float_simd b) { return _mm256_min_ps(a, b); }
    PREONMATH_FORCEINLINE float_simd sqrt(float_simd a) { return _mm256_sqrt_ps(a); }
    ...
    PREONMATH_FORCEINLINE double_simd max(double_simd a, double_simd b) { return _mm256_max_pd(a, b); }
    PREONMATH_FORCEINLINE double_simd min(double_simd a, double_simd b) { return _mm256_min_pd(a, b); }
    PREONMATH_FORCEINLINE double_simd sqrt(double_simd a) { return _mm256_sqrt_pd(a); }
