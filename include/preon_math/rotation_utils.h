...
#pragma once
#ifndef PREONMATH_ROTATION_UTILS_H
#define PREONMATH_ROTATION_UTILS_H
    ...
    namespace Math
    {
        namespace RotationUtils
        {
            ...
            matrix<3, 3, T> matrixFromQuaternions(const quat<T>& q)
            {
                ...
                return matrix<3, 3, T>((T)(1 - 2 * qy * qy - 2 * qz * qz), (T)(2 * qx * qy - 2 * qz * qw), (T)(2 * qx * qz + 2 * qy * qw),
                                       (T)(2 * qx * qy + 2 * qz * qw), (T)(1 - 2 * qx * qx - 2 * qz * qz), (T)(2 * qy * qz - 2 * qx * qw),
                                       (T)(2 * qx * qz - 2 * qy * qw), (T)(2 * qy * qz + 2 * qx * qw), (T)(1 - 2 * qx * qx - 2 * qy * qy));
            }
            ...
            euler<T> eulerAnglesFromQuaternion(const quat<T>& q)
            {
                ...
                if (cy > FEps)
                {
                    return euler<T>((T)RadToDeg(std::atan2(m(2, 1), m(2, 2))),
                                  (T)RadToDeg(std::atan2(-m(2, 0), cy)),
                                  (T)RadToDeg(std::atan2(m(1, 0), m(0, 0))));
                }
                // Else.
                return euler<T>((T)RadToDeg(std::atan2(-m(1, 2), m(1, 1))),
                              (T)RadToDeg(std::atan2(-m(2, 0), cy)),
                              0);
            }
...
#endif  // PREONMATH_ROTATION_UTILS_H
