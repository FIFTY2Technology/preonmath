...
namespace Math
{
    ...
    namespace Simd
    {
        ...
        {
            return Simd::make<A>(in);
        }

        PREONMATH_FORCEINLINE float_simd choose(const float_simd mask, const float_simd v1, const float_simd v2) { return blendv(v2, v1, mask); }

        PREONMATH_FORCEINLINE double_simd choose(const double_simd mask, const double_simd v1, const double_simd v2) { return blendv(v2, v1, mask); }
