...
template <size_t M, size_t N, typename T>
template <size_t _M, size_t _N> void matrix<M, N, T>::setToIdentity(typename std::enable_if<_M == _N, T>::type*)
{
    setToZero();
...
template <size_t M, size_t N, typename T>
template <size_t _M, size_t _N> void matrix<M, N, T>::transpose(typename std::enable_if<_M == _N, T>::type*)
{
...
template <size_t M, size_t N, typename T>
template <size_t _M, size_t _N> matrix<N, M, T> matrix<M, N, T>::inverted(typename std::enable_if<_M == _N && _M == 1, T>::type*) const
{
...
template <size_t M, size_t N, typename T>
template <size_t _M, size_t _N> matrix<N, M, T> matrix<M, N, T>::inverted(typename std::enable_if<_M == _N && _M == 2, T>::type*) const
{
    matrix<N, M, T> inv;
...
template <size_t M, size_t N, typename T>
template <size_t _M, size_t _N> matrix<N, M, T> matrix<M, N, T>::inverted(typename std::enable_if<_M == _N && _M == 3, T>::type*) const
{
    T det = this->determinant();
    // THROW_EXCEPTION(IsZero(det), std::exception("matrix not invertible"));
    if (IsZero(det))
...
template <size_t M, size_t N, typename T>
template <size_t _M, size_t _N> matrix<N, M, T> matrix<M, N, T>::inverted(typename std::enable_if<_M == _N && _M == 4, T>::type*) const
{
    matrix<N, M, T> inv;
    T det = this->determinant();
    // THROW_EXCEPTION(IsZero(det), std::exception("matrix not invertible"));
...
// Adjungate.
template <size_t M, size_t N, typename T>
template <size_t _M, size_t _N> matrix<N, M, T> matrix<M, N, T>::adjugate(typename std::enable_if<_M == _N && _M == 3, T>::type*) const
{
    matrix<M, N, T> out;
...
template <size_t M, size_t N, typename T>
template <size_t _M, size_t _N> T matrix<M, N, T>::determinant(typename std::enable_if<_M == _N && _M != 2 && _M != 3, T>::type*) const
{
    return ::determinant(*this, M);
}

template <size_t M, size_t N, typename T>
template <size_t _M, size_t _N> T matrix<M, N, T>::determinant(typename std::enable_if<_M == 3 && _N == 3, T>::type*) const
{
...
template <size_t M, size_t N, typename T>
template <size_t _M, size_t _N> T matrix<M, N, T>::determinant(typename std::enable_if<_M == 2 && _N == 2, T>::type*) const
{
    return (*this)(0, 0) * (*this)(1, 1) - (*this)(0, 1) * (*this)(1, 0);
}

template <size_t M, size_t N, typename T>
template <size_t _M, size_t _N> T matrix<M, N, T>::trace(typename std::enable_if<_M == _N, T>::type*) const
{
    T trace = 0;
    for (size_t d = 0; d < M; d++)
        trace += element(d, d);
...
template <size_t M, size_t N, typename T>
template <size_t _M, size_t _N> vec<M, T> matrix<M, N, T>::diagonal(typename std::enable_if<_M == _N, T>::type*) const
{
    vec<M, T> diagonal;
    for (size_t d = 0; d < M; d++)
